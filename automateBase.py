    ...
    def __init__ (self, listTransitions, listStates=None, label=None) :
        ...
        if listStates == None :
            ...
            for t in listTransitions :
                if not(t.stateSrc in self.listStates) :
                    self.listStates.append(t.stateSrc)
                if not(t.stateDest in self.listStates) :
                    self.listStates.append(t.stateDest)
        else :
